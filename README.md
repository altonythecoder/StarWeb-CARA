...
Fragmentation Probability (Pf): Calculates Specific Kinetic Energy (Ec​=21​mb​vrel2​/ma​) to determine if a collision would cause Catastrophic Fragmentation (Kessler Syndrome).
...
git clone https://github.com/altonythecoder/StarWeb-CARA.gitcd StarWeb-CARA
